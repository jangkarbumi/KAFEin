    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-kafein-text-secondary mt-2">
          Masuk ke akun KAFEin AI kamu
        </p>
      </div>

      {/* Email */}
      <div className="space-y-1.5">
        <label htmlFor="login-email" className="text-xs font-medium text-kafein-text-secondary uppercase tracking-wider">
          Email
        </label>
      ...
      {/* Password */}
      <div className="space-y-1.5">
        <label htmlFor="login-password" className="text-xs font-medium text-kafein-text-secondary uppercase tracking-wider">
          Password
        </label>
        <div className="glass-input rounded-xl flex items-center gap-3 px-4 py-3">
